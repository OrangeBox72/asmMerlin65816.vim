...
" Version:
"             2020/07/04 jwi.  added some asmSettings
"             2005/01/29 oel.  initial.  Oyd E. Leven <oyd11@softhome.net>
"
...
syn keyword asmTodo	    bug contained danger fixme note notice todo xxx warning jwi
syn region asmString      start=+"+ skip=+\\"+ end=+"+
syn keyword asmSettings   asc equ opt org
...
" hi link asmSettings   Statement #jwi orig
 hi link asmSettings   DiffText
